...
if (isset($message['member']['group_id']))  {
    ...
    case '1':
       $godbg = 'background-image: url(https://i.hizliresim.com/9avka5.png);';//admin grubu için renk ayarları
        break;
    case '2':
       $godbg = 'background-image: url(https://i.hizliresim.com/9avka5.png);';//global mod için renk ayarları
        break;
 case '0':
       $godbg = 'background-image: url(https://i.hizliresim.com/9avka5.png);';//normal üyeler için renk ayarları
         break;
 default:
      ...
      // Show avatars, images, etc.?
		  echo '      <div class="left_colum"><ul class="reset"> <!--Inicio Primera columna -->
                        <li class="avatar" style="overflow: auto;">
                           <a style="width:100%;height:100%;" href="', $scripturl, '?action=profile;u=', $message['member']['id'], '">
      ...
      echo '          <div class="left_colum"> <!--Inicio segunda columna-->
		...
		if (!$message['member']['is_guest'])
		{
			...
			if ((empty($settings['hide_post_group']) || $message['member']['group'] == '') && $message['member']['post_group'] != '')
				echo '';
			echo '				
								<div style="margin-top:8px;margin-left:-8px;" class="god-rank">', $message['member']['group_stars'], '</div>
			...
			// Show avatars, images, etc.?
				  ...
				  <div id="ilk" style="position: absolute; margin-left: 20px; margin-top: 3px;">
								<i class="fas fa-dice-d20" style="font-size: 60px; color: #fff;"></i>
								<div style=" z-index: 5; position: absolute; margin-left: -17px; margin-top: -71px; text-align: center;">
									<img src="https://www.rina-roleplay.com/forum/Themes/rinatheme/images/profilf/bos.png">
	  							</div>

								<div style=" z-index: 5; position: absolute; margin-left: -5px; margin-top: -4px; text-align: center;">
									<span data-toggle="tooltip" title="" data-placement="top" style="position: absolute; margin-top: 0.7em; " data-original-title="68%"><div class="progress" style="background-color: #f5f5f53b; width: 67px; height: 8px;">
										<div name="expbari" class="progress-bar progress-bar-striped" role="progressbar" style="background-color: #318d49; width: 68%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
									</span>
								 </div>
				  ...
				  <div id="karakterad" style="position: absolute; margin-left: 243px; margin-top: -10px;width:100px;">
								<span class="badge" style="background-color: #000; color: #fff;padding: 3px 7px;border-radius:10px;">1 seviye</span>
							</div>
							<div id="karakterad" style="position: absolute; margin-left: 115px; margin-top: 15px;">
								<span style="color: #fff; font-weight: bold; font-size: 13px;">  <a style="color: #fff;" href="#">Ad Soyad</a></span>
								<br>
								<span style="color: #fff;  font-size: 11px;">(Birlik)</span>
								<br>
								<span style="color: #fff; font-size: 11px;"><i class="fas fa-clock"></i> GG/AA/YYYY SS:DD</span>
							</div>
				  <div id="online" style="position: absolute; margin-left: -15px; margin-top: -5px;" data-toggle="tooltip" title="" data-original-title=" Oyunda">
								<i class="fas fa-square-full" style="font-size: 14px; color: #808080; border-radius: 2px; border: 1px solid #2f2f2f8a;margin-left:-2px;margin-top:-6px;"></i>
							</div></div>
