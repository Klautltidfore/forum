...
<div id="profileview" class="flow_auto">
	...
	<div id="basicinfo">
		<div style="position:relative;min-height:300px;max-Height:600px;" class="windowbg">
			...
			<div class="', $post['alternate'] == 0 ? 'windowbg2' : 'windowbg', ' core_posts">
				...
				<div class="content">
					...
					<div class="topic_details">
						<h5><strong><a href="', $scripturl, '?board=', $post['board']['id'], '.0">', $post['board']['name'], '</a> / ', $post['prefix'], ' ', $post['prefix'], ' <a href="', $scripturl, '?topic=', $post['topic'], '.', $post['start'], '#msg', $post['id'], '">', $post['subject'], '</a></strong></h5>
